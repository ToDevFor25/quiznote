...
(function () {
  ...
  var PATH = [
    'note-names', 'ledger-lines', 'note-values', 'dotted-notes', 'time-signatures', 'accidentals', 'tempo-markings', 'dynamics', 'articulation', 'score-navigation', 'ornaments', 'piano-quiz', 'piano-keyboard',
